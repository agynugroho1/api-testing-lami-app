...
#    Given I set Bearer Token
#    When I send PUT request for profile user with data "image" is "image-profile.png", "name" is "Agy", "email" is "testinglami@ngetest.com", and "password" is "rpperak"
#    Then Response code is 200
...
#    Given I set Bearer Token
#    When I send PUT request for profile user with data "image" is "", "name" is "Kera", "email" is "lamitestcase@test.com", and "password" is "rp100perak"
#    Then Response code is 200
#    And Response body with jsonPath "message" should be equal "success update data"
#
#  @Positive
