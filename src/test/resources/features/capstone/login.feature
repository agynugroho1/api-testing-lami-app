Feature: Login LamiApp
  ...
  @Positive @SuccessLogin
    ...
    And Return body should be with jsonSchema "login-success-schema.json"
    And Return body with jsonPath "message" should be equal "login success"
  ...
  @Negative @FailedLogin @InvalidEmail
    ...
    And Return body should be with jsonSchema "login-invalidemail-schema.json"
    And Return body with jsonPath "message" should be equal "user not found"
  ...
  Scenario: login with valid email and invalid password
    ...
    Then The response status code 404
    And Return body should be with jsonSchema "login.invalidpassword-schema.json"
    And Return body with jsonPath "message" should be equal "wrong password"
  ...
  Scenario: login with valid email and invalid email and invalid password
    ...
    Then The response status code 404
    And Return body should be with jsonSchema "login-invaliddata-schema.json"
    And Return body with jsonPath "message" should be equal "user not found"